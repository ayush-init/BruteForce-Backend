...
const mapDatabaseError = (error, resource) => {
    ...
    if (error.code === "P2002") {
        ...
        if (field?.includes("email")) {
            return new ApiError_1.ApiError(exports.HTTP_STATUS.CONFLICT, "Email already exists", [], "EMAIL_EXISTS");
        }
        if (field?.includes("username")) {
            return new ApiError_1.ApiError(exports.HTTP_STATUS.CONFLICT, "Username already exists", [], "USERNAME_EXISTS");
        }
        if (field?.includes("enrollment_id")) {
            return new ApiError_1.ApiError(exports.HTTP_STATUS.CONFLICT, "Enrollment ID already exists", [], "ENROLLMENT_ID_EXISTS");
        }
        return new ApiError_1.ApiError(exports.HTTP_STATUS.CONFLICT, "Duplicate entry found", [], "DUPLICATE_ENTRY");
    }
    if (error.code === "P2003") {
        return new ApiError_1.ApiError(exports.HTTP_STATUS.BAD_REQUEST, "Invalid foreign key reference", [], "INVALID_REFERENCE");
    }
...
const getUserFriendlyMessage = (statusCode, message, code) => {
    ...
    if (code) {
        const codeMessage = exports.ERROR_MESSAGES[code];
        if (codeMessage)
            return codeMessage;
    }
    // Fall back to status code based messages
    switch (statusCode) {
        case exports.HTTP_STATUS.BAD_REQUEST:
            return exports.ERROR_MESSAGES.BAD_REQUEST;
        case exports.HTTP_STATUS.UNAUTHORIZED:
            return exports.ERROR_MESSAGES.UNAUTHORIZED;
        case exports.HTTP_STATUS.FORBIDDEN:
            return exports.ERROR_MESSAGES.FORBIDDEN;
        case exports.HTTP_STATUS.NOT_FOUND:
            return exports.ERROR_MESSAGES.NOT_FOUND;
        case exports.HTTP_STATUS.CONFLICT:
            return exports.ERROR_MESSAGES.CONFLICT;
        case exports.HTTP_STATUS.UNPROCESSABLE_ENTITY:
            return exports.ERROR_MESSAGES.UNPROCESSABLE_ENTITY;
        case exports.HTTP_STATUS.INTERNAL_SERVER_ERROR:
            return exports.ERROR_MESSAGES.INTERNAL_SERVER_ERROR;
        default:
