...
// ===== STUDENT AUTH (Public) =====
router.post('/student/register', rateLimiter_1.authLimiter, auth_controller_1.registerStudent);
router.post('/student/login', rateLimiter_1.authLimiter, auth_controller_1.loginStudent);
router.post('/student/logout', auth_controller_1.logoutStudent);
// ===== ADMIN AUTH (Public) =====
// Note: This is for ALL admins (Superadmin, Teacher, Intern)
router.post('/admin/login', rateLimiter_1.authLimiter, auth_controller_1.loginAdmin);
