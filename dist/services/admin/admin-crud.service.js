...
exports.deleteAdminService = exports.updateAdminService = exports.createAdminService = void 0;
...
const createAdminService = async (adminData) => {
    try {
        ...
        // Hash password
        const hashedPassword = await (0, password_util_1.hashPassword)(adminData.password);
        // Create admin
...
const updateAdminService = async (id, updateData) => {
    try {
        ...
        if (updateData.password) {
            ...
            updateData.password_hash = await (0, password_util_1.hashPassword)(updateData.password);
