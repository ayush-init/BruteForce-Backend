...
exports.getStudentRankDirect = exports.getLeaderboardWithPagination = void 0;
const prisma_1 = __importDefault(require("../../config/prisma"));
const ApiError_1 = require("../../utils/ApiError");
const leaderboard_data_service_1 = require("./leaderboard-data.service");
const getLeaderboardWithPagination = async (filters, pagination, search) => {
    try {
        ...
        const validYears = await (0, leaderboard_data_service_1.getAvailableYears)();
        ...
        let availableYears = [];
        try {
            availableCities = await (0, leaderboard_data_service_1.getCityYearMapping)();
        }
        catch (error) {
        ...
        try {
            availableYears = await (0, leaderboard_data_service_1.getAvailableYears)();
        }
        catch (error) {
...
const getStudentRankDirect = async (studentId, filters) => {
    try {
        ...
        const availableCities = await (0, leaderboard_data_service_1.getCityYearMapping)();
        const availableYears = await (0, leaderboard_data_service_1.getAvailableYears)();
