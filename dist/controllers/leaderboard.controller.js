...
const leaderboard_data_service_1 = require("../services/leaderboard/leaderboard-data.service");
...
exports.getAvailableYearsController = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const years = await (0, leaderboard_data_service_1.getAvailableYears)();
